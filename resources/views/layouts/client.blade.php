...
<head>
    ...
    <title>Legendary writers | Client</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Legendary Writers</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('inProcess') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('order.ongoing') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('client.messages') }}" class="nav-link">
