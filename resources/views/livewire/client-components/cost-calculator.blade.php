<div>
    <div class="card card-body paper">
        <h3 class="text-center text-dark fw-bolder">Calculate the Price</h3>
        <form>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="my-3"><a class="btn btn-md btn-info text-white" href="{{ route('create.order') }}">Write
                            my
                            paper</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="fs-3">Your Price is <span class="fw-bolder text-success">${{ $totalCost }}.00</span>
                    </div>
                </div>
            </div>
