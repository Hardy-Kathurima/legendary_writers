                ...
                <table id="orderCompleted" class="table table-sm table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="sortBy('order_id')" style="cursor: pointer;">Paper Type
                                <span class="ml-3"><i class="fa fa-sort"></i></span>
                            </th>
                            <th wire:click="sortBy('order_id')" style="cursor: pointer;">Deadline
                                <span class="ml-3"><i class="fa fa-sort"></i></span>
                            </th>
                            <th wire:click="sortBy('order_id')" style="cursor: pointer;">Days Left
                                <span class="ml-3"><i class="fa fa-sort"></i></span>
                            </th>
                            <th wire:click="sortBy('order_id')" style="cursor: pointer;">Order cost
                                <span class="ml-3"><i class="fa fa-sort"></i></span>
                            </th>
